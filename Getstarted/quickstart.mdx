---
title: "Quickstart"
keywords: ["how to build llm workflow", "llm workflow quickstart", "llmcontrols quickstart", "build ai workflows"]
---
...
- Integrate flows into your applications, as explained in [Run your flows from external applications](https://docs.llmcontrols.ai/Getstarted/quickstart#run-your-flows-from-external-applications%E2%80%8B).
...
Tweaks are added to the /run endpoint's payload. To assist with formatting, you can define tweaks in the LLM Controls Tweaks pane before copying the code snippet.
