...
3. If you're using the cloud version, make sure to create an API key in your **Settings \> LLMC API** tab and set it as an environment variable (LLMC_API_KEY) in your development environment before making requests.
