...
Polling is added to the `/run` endpoint's `payload`. To assist with formatting, you can define polling in LLMControlMCP.an's **Input Schema** pane before copying the code snippet.
