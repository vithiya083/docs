...
LLM Controls has four distinct regions: the [workspace](https://devrel.mintlify.app/Concepts/LLMCoverview#workspace%E2%80%8B) is the main area where you build your flows. The components sidebar is on the left and lists the available [components](https://devrel.mintlify.app/Concepts/LLMCoverview#components%E2%80%8B). The [playground](https://devrel.mintlify.app/Concepts/LLMCoverview#playground%E2%80%8B) and [publish pane](https://devrel.mintlify.app/Concepts/LLMCoverview#publish-pane%E2%80%8B) are available in the upper right corner.
