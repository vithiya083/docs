...
![Llmc Component Pn](/images/llmc_component.png)
...
To access the **Logs** pane, click your **Flow N.ame** and then select **Logs**.
...
The dropdown menu labeled with the project name offers several management and customization options for the current flow in the LLMControls workspace:
