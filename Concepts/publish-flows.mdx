...
![Publish Flow Pn](/images/Publish_flow.png)
...
| **Mode**    | **Query Param** | **Use Case**                         | **Simplicity** | **Suitable For Long Workflow** |
| :---------- | :-------------- | :----------------------------------- | :------------- | :----------------------------- |
...
POST https://api.llmcontrols.ai/api/v1/run/YOUR_FLOW_ID
```
...
```
{
  "status": "COMPLETED",
  "result": {
    "output": "Here's something interesting..."
  }
}
```
...
```
<script
  src="https://cdn.jsdelivr.net/gh/logspace-ai/llmc-embedded-chat@v1.0.7/dist/build/static/js/bundle.min.js">
</script>
  <llmc-chat
    window_title="Customer Service - Advanced (2)"
