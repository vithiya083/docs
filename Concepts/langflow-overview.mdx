...
- **Undo**: Revert the last action taken in the project. Keyboard shortcut: <kbd>Control\+Z</kbd>

  (or <kbd>Command\+Z</kbd>

  on macOS).
- **Redo**: Reapply a previously undone action. Keyboard shortcut: <kbd>Control\+Y</kbd>

  (or <kbd>Command\+Y</kbd>
