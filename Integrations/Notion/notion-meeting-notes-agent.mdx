...
- [Notion App](https://docs.langflow.org/integrations/notion/setup)
- [Notion API key](https://www.notion.so/my-integrations)
- [OpenAI API key](https://platform.openai.com/account/api-keys)
- [Download Flow Meeting Agent Flow](https://docs.langflow.org/assets/files/Meeting_Notes_Agent-b29188c0cb70736d19dd52965db5f352.json)(Download link)
...
![Meeting1 Pn](/images/meeting1.png)

### **Meeting Transcript (Text Input)**[**​**](https://docs.langflow.org/integrations/notion/notion-agent-meeting-notes#meeting-transcript-text-input)

This component allows users to input the meeting transcript directly into the flow.

### **List Users (Notion Component)**[**​**](https://docs.langflow.org/integrations/notion/notion-agent-meeting-notes#list-users-notion-component)

- **Purpose**: Retrieves a list of users from the Notion workspace.
- **Input**: Notion Secret (API key)
- **Output**: List of user data

### **List Databases (Notion Component)**[**​**](https://docs.langflow.org/integrations/notion/notion-agent-meeting-notes#list-databases-notion-component)
...
### **Prompt**[**​**](https://docs.langflow.org/integrations/notion/notion-agent-meeting-notes#prompt)
...
### **Meeting Summarizer (Tool Calling Agent)**[**​**](https://docs.langflow.org/integrations/notion/notion-agent-meeting-notes#meeting-summarizer-tool-calling-agent)
...
![Meeting2 Pn](/images/meeting2.png)

### **Notion Agent (Tool Calling Agent)**[**​**](https://docs.langflow.org/integrations/notion/notion-agent-meeting-notes#notion-agent-tool-calling-agent)
...
#### **Create Page**[**​**](https://docs.langflow.org/integrations/notion/notion-agent-meeting-notes#create-page)
...
#### **Update Page Property**[**​**](https://docs.langflow.org/integrations/notion/notion-agent-meeting-notes#update-page-property)
...
#### **Add Content to Page**[**​**](https://docs.langflow.org/integrations/notion/notion-agent-meeting-notes#add-content-to-page)
...
1. Open LLMC and create a new project.
2. Add the components listed above to your flow canvas, or download the [Flow Meeting Agent Flow](https://docs.langflow.org/assets/files/Meeting_Notes_Agent-b29188c0cb70736d19dd52965db5f352.json)(Download link) and **Import** the JSON file into Langflow.
...
## **Customization**[**​**](https://docs.langflow.org/integrations/notion/notion-agent-meeting-notes#customization)
...
## **Troubleshooting**[**​**](https://docs.langflow.org/integrations/notion/notion-agent-meeting-notes#troubleshooting)
...
4. Review the LLMC logs for any error messages.

For more advanced usage and integration options, refer to the [Notion API documentation](https://developers.notion.com/) and [Langflow documentation](https://docs.langflow.org/).