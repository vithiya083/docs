...
2. Add the components listed above to your flow canvas, or Download the [Conversation Agent Flow](https://docs.langflow.org/assets/files/Conversational_Notion_Agent-29ab60cb11e52e7bbb1a4917f4799629.json)(Download link) and **Import** the JSON file into LLMC.
