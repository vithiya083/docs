...
To integrate with LLMC, just add your LangWatch API as a LLMC environment variable and you are good to go\!
...
3. Restart LLMC using `langflow run --env-file .env`
