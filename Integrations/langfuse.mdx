---
title: "Integrate Langfuse with Langflow file"
---
...
## **Start Langflow and view traces in Langfuse**[**​**](https://docs.langflow.org/integrations-langfuse#start-langflow-and-view-traces-in-langfuse)
...
## **Run Langfuse and Langflow with Docker Compose**[**​**](https://docs.langflow.org/integrations-langfuse#run-langfuse-and-langflow-with-docker-compose)
...
3. Add your Langflow API keys to your `docker-compose.yml` file. An example [docker-compose.yml](https://github.com/langflow-ai/langflow/blob/main/docker_example/docker-compose.yml) file is available in the Langflow GitHub repo.
4. Start the Docker container.
5. To confirm Langfuse is connected to your Langflow container, run this command. Ensure you've exported `LANGFLOW_HOST` as a variable in your terminal.
