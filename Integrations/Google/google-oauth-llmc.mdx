...
keywords: ["google oauth integration", "read google docs with ai", "automate gmail with ai ", "Google OAuth setup"]
---
...
<Accordion title="Parameters">
  **Inputs**
  ...
  | search_query                 | Gmail Search Query           | Gmail search operators (e.g., 'from:<a target="_blank" rel="noopener noreferrer noflow" href="mailto:user@domain.com">[user@domain.com](mailto:user@domain.com)</a>   has:attachment') |
