...
LLMC integrates with the [Google Vertex AI API](https://console.cloud.google.com/marketplace/product/google/aiplatform.googleapis.com) for authenticating the [Vertex AI embeddings model](https://docs.langflow.org/components-embedding-models#vertexai-embeddings) and [Vertex AI](https://docs.langflow.org/components-models#vertexai) components.
