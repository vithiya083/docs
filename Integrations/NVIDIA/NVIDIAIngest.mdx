---
title: "Integrate NVIDIA Retriever Extraction with LLMControls"
---
...
- The **NVIDIA Retriever Extraction** component requires the installation of additional dependencies to your LLMControls environment. To install the dependencies in a virtual environment, run the following commands.
  - If you have the LLMControls repository cloned and installed from source:
- If you are installing LLMControls from the Python Package Index:
