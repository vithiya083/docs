---
title: "Integrate NVIDIA G-Assist with LLMC"
---

<Note>
  **important**

  This component is available only for LLMC users with NVIDIA GPUs on Windows systems.
</Note>
...
- NVIDIA GPU
- `gassist.rise` package installed. This package is already installed with LLMC.
...
- The NVIDIA G-Assist message response is wrapped in a LLMC [Message](https://devrel.mintlify.app/Concepts/LLMCobjects#message-object%E2%80%8B) object.