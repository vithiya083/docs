---
title: "Integrate NVIDIA G-Assist with LLM Controls"
---
...
- The NVIDIA G-Assist message response is wrapped in an LLM Controls [Message](https://devrel.mintlify.app/Concepts/LLMCobjects#message-object%E2%80%8B) object.