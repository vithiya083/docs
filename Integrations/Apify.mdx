---
title: "Integrate Apify with LLMControls"
---
...
Apify components in LLMControls run **Actors** to accomplish tasks like data extraction, content analysis, and SQL operations.
