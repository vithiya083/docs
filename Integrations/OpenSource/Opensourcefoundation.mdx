---
title: "LLMControls Open Source Foundation, Tools, and Models"
---
...
LLMControls is an MIT-licensed open-source platform built on top of the Langflow architecture.
...
LLMControls does not ship model weights.
