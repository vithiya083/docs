...
This page outlines the open-source foundation behind LLM Controls, including the core architecture it is built on, the backend and frontend technology stack, and the open-source model runtimes it supports.
