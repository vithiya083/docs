---
title: "LLM Controls Foundation, Tools, and Models"
---

This page outlines the foundation behind LLM Controls, including the open-source architecture it is built on, the backend and frontend technology stack, and the open-source model runtimes it supports.

## **Built on Langflow (Open Source)**

LLM Controls is built on top of **Langflow**, an MIT-licensed open-source platform that provides the core architectural foundation.

Langflow's core design patterns include:
...
This open-source foundation provides the workflow engine that powers LLM Controls' flow creation and execution.
...
LLM Controls does not ship model weights. Instead, it supports a range of open-source and local model runtimes and embedding stacks, including:
...
LLM Controls is made possible by the incredible work of the open-source community. We extend our deepest gratitude to:

- The **Langflow** team for providing the MIT-licensed foundation upon which LLM Controls is built
- The maintainers and contributors of **LangChain**, **LiteLLM**, **React**, **Vite**, and the hundreds of other open-source projects that power our platform
- The broader AI and developer communities who continue to advance the ecosystem through collaboration, innovation, and shared knowledge

We are proud to build on the shoulders of giants and remain committed to supporting and contributing back to the open-source community.