---
title: "Integrate Cleanlab Evaluations with LLMControls"
---
...
This LLMControls integration provides three LLMControls components that assess and improve the trustworthiness of any LLM or RAG pipeline output.
