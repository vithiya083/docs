---
title: "Integrate Opik with LLM Controls"
---
...
This guide walks you through how to configure LLM Controls to collect [tracing](https://www.comet.com/docs/opik/tracing/log_traces) data about your flow executions and automatically send the data to Opik.
...
Set your Opik configuration as environment variablesCall the CLI opik configure to save your Opik configuration in the same environment where you run LLM Controls.
