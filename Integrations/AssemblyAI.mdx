...
2. Add the components listed above to your flow canvas, or download the [AssemblyAI Transcription and Speech AI Flow](https://docs.langflow.org/assets/files/AssemblyAI_Flow-368be24ae9542f0b8b5253cc9d97b42f.json)(Download link) and **Import** the JSON file into LLMControls.
