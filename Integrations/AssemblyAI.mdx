---
title: "AssemblyAI"
keywords: ["assemblyai integration", "speech to text api", "transcribe audio with ai"]
---
...
2. The user can also input an LLM prompt. for example, to generate a summary of the transcript.
...
3. Connect the components as shown in the flow diagram.
   ...
   <Tip>
     **Tip**: Freeze the path of the _Start Transcript_ component to only submit the file once.
   </Tip>
