...
## **Prerequisites**[**​**](https://docs.langflow.org/integrations-assemblyai#prerequisites)
...
## **Components**[**​**](https://docs.langflow.org/integrations-assemblyai#components)

![Assembly Pn](/images/assembly.png)

### **AssemblyAI Start Transcript**[**​**](https://docs.langflow.org/integrations-assemblyai#assemblyai-start-transcript)

This component allows you to submit an audio or video file for transcription.

<Tip>
  You can freeze the path of this component to only submit the file once.
</Tip>
...
- **Input**:
  ...
  - Language (Optional): The language of the audio file. Can be set manually if automatic language detection is disabled. See [supported languages](https://www.assemblyai.com/docs/getting-started/supported-languages) for a list of supported language codes.
...
### **AssemblyAI Poll Transcript**[**​**](https://docs.langflow.org/integrations-assemblyai#assemblyai-poll-transcript)
...
- **Output**:
  ...
  ### **AssemblyAI Get Subtitles**[**​**](https://docs.langflow.org/integrations-assemblyai#assemblyai-get-subtitles)
...
### **AssemblyAI LeMUR**[**​**](https://docs.langflow.org/integrations-assemblyai#assemblyai-lemur)
...
## **Run the Transcription and Speech AI Flow**[**​**](https://docs.langflow.org/integrations-assemblyai#run-the-transcription-and-speech-ai-flow)

To run the Transcription and Speech AI Flow:

1. Open LLM Controls and create a new project.
2. Add the components listed above to your flow canvas, or download the [AssemblyAI Transcription and Speech AI Flow](https://docs.langflow.org/assets/files/AssemblyAI_Flow-368be24ae9542f0b8b5253cc9d97b42f.json)(Download link) and **Import** the JSON file into LLM Controls.
...
4. Review the LLM Controls logs for any error messages.
