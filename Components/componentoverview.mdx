...
To add a component to a flow, drag the component from the **Components** menu to the [**Workspace**](https://docs.langflow.org/concepts-overview).
...
1. Hold <kbd>Shift</kbd>
   ...
   , and then click and drag to highlight all components you want to merge. Components must be completely within the selection area to be merged.
