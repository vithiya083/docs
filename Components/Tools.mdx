...
The **MCP connection** component exposes Model Context Protocol (MCP) servers, including your other flows, as tools for LLM Controls agents. For information about this component.

### **MCP Tools (deprecated)**

The **MCP Tools (stdio)** and **MCP Tools (SSE)** components are deprecated as of LLM Controls version 1.3.
