...
The **MCP connection** component exposes Model Context Protocol (MCP) servers, including your other flows, as tools for LLMControls agents. For information about this component.
