---
title: "Model components in LLMControls"
---
...
This example has the OpenAI model in a chatbot flow. For more information, see the [Basic prompting flow](/Templates/Basicprompting).
...
To use this component in a flow, connect LLMControls to your locally running Ollama server and select a model.
