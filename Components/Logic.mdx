...
<Note>
  **important**
  ...
  This component is deprecated as of LLM Controls version 1.1.2. Instead, use the [<u>Run flow component</u>](https://docs.llmcontrols.ai/Components/Logic#run-flow%E2%80%8B)
</Note>
