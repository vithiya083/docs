...
Follow along with this step-by-step video guide for creating this flow and adding agentic RAG: [Mastering the Loop Component & Agentic RAG in L](https://www.youtube.com/watch?v=9Wx7WODSKTo)**LMControls.**
...
### **Flow as a tool**[**​**](https://docs.langflow.org/components-logic#flow-as-tool)
