...
Follow along with this step-by-step video guide for creating this flow and adding agentic RAG: [Mastering the Loop Component & Agentic RAG in L](https://www.youtube.com/watch?v=9Wx7WODSKTo)**LM Controls.**
...
<Note>
  **important**
  ...
  This component is deprecated as of LLM Controls version 1.1.2. Instead, use the [<u>Run flow component</u>](https://devrel.mintlify.app/Components/Logic#run-flow%E2%80%8B)
</Note>
