...
<Note>
  **important**
  ...
  This component is deprecated as of LLMC version 1.1.2. Instead, use the [<u>Run flow component</u>](https://devrel.mintlify.app/Components/Logic#run-flow%E2%80%8B)
</Note>
