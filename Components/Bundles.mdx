...
<Accordion title="Parameters">
  **Inputs**
  ...
  <td>Search Results from a Vector Store.</td>
  </tr>
  ...
  <td>(inherited from base, default: 3)</td>
  </tr>
  ...
  <td>Options: rerank-english-v3.0, rerank-multilingual-v3.0, rerank-english-v2.0, rerank-multilingual-v2.0.</td>
  </tr>
  </tbody>
  </table>
