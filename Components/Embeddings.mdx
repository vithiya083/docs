---
title: "Embeddings models in LLM Controls"
---
...
<Note>
  **important**
  ...
  This component is deprecated as of LLM Controls version 1.1.2. Instead, use the [<u>Astra DB vector store component</u>](https://devrel.mintlify.app/Components/Vectorstores#astra-db-vector-store).
</Note>
...
<Note>
  **note**
  ...
  This component is deprecated as of LLM Controls version 1.0.18. Instead, use the [<u>Hugging Face Embeddings Inference component</u>](https://devrel.mintlify.app/Components/Embeddings#hugging-face-embeddings-inference).
</Note>
