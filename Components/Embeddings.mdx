...
<Note>
  **important**
  ...
  This component is deprecated as of LLMC version 1.1.2. Instead, use the [<u>Astra DB vector store component</u>](https://docs.langflow.org/components-vector-stores#astra-db-vector-store).
</Note>
