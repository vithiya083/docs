---
title: "Embeddings models in LLMC"
---
...
<Note>
  **important**
  ...
  This component is deprecated as of LLMC version 1.1.2. Instead, use the [<u>Astra DB vector store component</u>](https://devrel.mintlify.app/Components/Vectorstores#astra-db-vector-store).
</Note>
...
<Note>
  **note**
  ...
  This component is deprecated as of LLMC version 1.0.18. Instead, use the [<u>Hugging Face Embeddings Inference component</u>](https://docs.langflow.org/components-embedding-models#hugging-face-embeddings-inference).
</Note>
...
To use this component in a flow, connect LLMC to your locally running Ollama server and select an embeddings model.
