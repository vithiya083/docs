...
<Note>
  **note**
  ...
  This component is deprecated as of LLMC version 1.0.18. Instead, use the [<u>Hugging Face Embeddings Inference component</u>](https://devrel.mintlify.app/Components/Embeddings#hugging-face-embeddings-inference).
</Note>
