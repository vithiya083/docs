...
1. **Embedding Model**: Use your own embedding model by connecting an [Embeddings](/Components/Embeddings) component in Langflow.
...
1. To use this component in a flow, connect it to a component that outputs **Data** or **DataFrame**. This example splits text from a [URL](https://devrel.mintlify.app/Components/Data#url) component, and computes embeddings with the connected **OpenAI Embeddings** component. Chroma DB computes embeddings by default, but you can connect your own embeddings model, as seen in this example.
   ...
   ![Vector Store 4 Pn](/images/vector_store_4.png)
...
The **Ingest** mode works similarly to [ChromaDB](https://devrel.mintlify.app/Components/Vectorstores#chroma-db), and persists your database to the Langflow cache directory. The Langflow cache directory location is specified in `LLMC_CONFIG_DIR`. For more information .
