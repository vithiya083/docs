...
The **Ingest** mode works similarly to [ChromaDB](https://devrel.mintlify.app/Components/Vectorstores#chroma-db), and persists your database to the LLM Controls cache directory. The LLM Controls cache directory location is specified in `LLMC_CONFIG_DIR`. For more information.
