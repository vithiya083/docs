...
<Tip>
  **ICON USAGE**
  ...
  Langflow uses [<u>Lucide</u>](https://lucide.dev/icons) for icons. To assign an icon to your component, set the icon attribute to the name of a Lucide icon as a string, such as `icon = "file-text"`. LLMControls renders icons from the Lucide library automatically.
</Tip>
