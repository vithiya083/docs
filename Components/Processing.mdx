...
This component performs operations on [Data](https://dohttps://devrel.mintlify.app/Concepts/LLMCobjects#data-object%E2%80%8Bcs.langflow.org/concepts-objects#data-object) objects, including selecting keys, evaluating literals, combining data, filtering values, appending/updating data, removing keys, and renaming keys.
