...
The Current Date component returns the current date and time in a selected timezone. This component provides a flexible way to obtain timezone-specific date and time information within a LLMControls pipeline.
...
<Note>
  **info**
  ...
  Prior to LLMControls 1.1, this component was known as the Chat Memory component.
</Note>
