---
title: "Input and output components in LLM Controls"
---
...
<Accordion title="Parameters" icon="">
  **Inputs**
  ...
  | Name        | Display Name  | Info                                              |
  | :---------- | :------------ | :------------------------------------------------ |
  | input_value | Markdown Text | Markdown formatted text to convert to plain text. |
...
1. To use the **Chat Input** and **Chat Output** components in a flow, connect them to components that accept or send the [Message](https://docs.llmcontrols.ai/Concepts/LLMCobjects#message-object%E2%80%8B) type.
