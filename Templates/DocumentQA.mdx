...
2. To select a document to load, in the **File** component, click the **Select files** button. Select a local file or a file loaded with [File management](/Concepts/manage-files), and then click **Select file**. The file name appears in the component.
