...
![Blogwriter Pn](/images/blogwriter.png)
...
1. Click the **Playground** button, and then click **Run Flow**. A blog post about Langflow is generated, with content sourced from `llmc.org` and `docs.llmc.org`.
