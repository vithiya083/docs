...
Build a **Simple Agent** flow for an agentic application using the [Agent](https://docs.langflow.org/agents) component.
...
## **Open Langflow and start a new flow**[**​**](https://docs.langflow.org/simple-agent#open-langflow-and-start-a-new-flow)
...
ow that your query has completed the journey from **Chat input** to **Chat output**, you have completed the **Simple Agent** flow.