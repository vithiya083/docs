...
In this flow, multiple **Tool-calling agents** reason using an **OpenAI** LLM to plan a travel journey. Each agent is given a different responsibility defined by its **System Prompt** field.
...
## **Prerequisites**[**​**](https://docs.langflow.org/travel-planning-agent#prerequisites)

- [An OpenAI API key](https://platform.openai.com/)
- [A Search API key](https://www.searchapi.io/)

## **Open LLM Controls and start a new flow**[**​**](https://docs.langflow.org/travel-planning-agent#open-langflow-and-start-a-new-flow)
...
## **Run the travel planning agent flow**[**​**](https://docs.langflow.org/travel-planning-agent#run-the-travel-planning-agent-flow)
