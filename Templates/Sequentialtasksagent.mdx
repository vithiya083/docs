...
## **Prerequisites**[**​**](https://docs.langflow.org/sequential-agent#prerequisites)
...
## **Open Langflow and create a new flow**[**​**](https://docs.langflow.org/sequential-agent#open-langflow-and-create-a-new-flow)
...
## **Run the Sequential Tasks Agent flow**[**​**](https://docs.langflow.org/sequential-agent#run-the-sequential-tasks-agent-flow)
...
## **Next steps**[**​**](https://docs.langflow.org/sequential-agent#next-steps)

To create your own multi-agent flow, see [Create a problem solving agent](https://docs.langflow.org/agents).