...
Build a **Financial Report Parser** flow with the [Structured output](/Components/Helpers) and [Parser](https://docs.langflow.org/components-processing#parser) components to parse LLM responses into a structured format.
