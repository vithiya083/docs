...
Build a **Financial Report Parser** flow with the [Structured output](https://devrel.mintlify.app/Components/Helpers#structured-output) and [Parser](https://devrel.mintlify.app/Components/Processing#parser) components to parse LLM responses into a structured format.
