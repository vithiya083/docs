...
The **NVIDIA Retriever Extraction** component imports the NVIDIA `Ingestor` client, ingests files with requests to the NVIDIA ingest endpoint, and outputs the processed content as a list of [Data](https://docs.langflow.org/concepts-objects#data-object) objects. `Ingestor` accepts additional configuration options for data extraction from other text formats. To configure these options, see the [component parameters](https://docs.langflow.org/integrations-nvidia-ingest#parameters).

## **Prerequisites**[**​**](https://docs.langflow.org/integrations-nvidia-ingest#prerequisites)
...
## **Use the NVIDIA Retriever Extraction component in a flow**[**​**](https://docs.langflow.org/integrations-nvidia-ingest#use-the-nvidia-retriever-extraction-component-in-a-flow)
...
## **NVIDIA Retriever Extraction component parameters**[**​**](https://docs.langflow.org/integrations-nvidia-ingest#parameters)
...
### **Outputs**[**​**](https://docs.langflow.org/integrations-nvidia-ingest#outputs)

The **NVIDIA Retriever Extraction** component outputs a list of [Data](https://docs.langflow.org/concepts-objects#data-object) objects where each object contains:
